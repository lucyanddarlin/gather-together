function _extends() {
  ...
  return Reflect.apply(_extends, this, arguments)
}
    ...
    return asyncMap(
      ...
      (data, doIt) => {
        ...
        function cb(e) {
          ...
          if (!options.suppressWarning && errors.length > 0) {
          ...
          if (options.first && errors.length > 0) {
          ...
          if (!deep) {
            ...
            schema.validate(
              ...
              (errs) => {
                ...
                doIt(finalErrors.length > 0 ? finalErrors : null)
              }
            )
          }
        }
